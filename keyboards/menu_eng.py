...
def torty_assort_eng() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_eng_cakes():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'tort_eng_{i[2]}'))
...
def bent_assort_eng() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_eng_bent():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'bent_eng_{i[2]}'))
    btn_assort.add(btn_back)
    return btn_assort
...
def mak_assort_eng() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_eng_mak():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'mak_eng_{i[2]}'))
    btn_assort.add(btn_back)
    return btn_assort
