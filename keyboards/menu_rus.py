...
def torty_assort_rus() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_rus_cakes():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'tort_rus_{i[0]}'))
...
def bent_assort_rus() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_rus_bent():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'bent_rus_{i[0]}'))
    btn_assort.add(btn_back)
    return btn_assort
...
def mak_assort_rus() -> InlineKeyboardMarkup:
    ...
    for i in sql.get_rus_mak():
        btn_assort.add(InlineKeyboardButton(f'{i[1]}', callback_data=f'mak_rus_{i[0]}'))
    btn_assort.add(btn_back)
    return btn_assort
